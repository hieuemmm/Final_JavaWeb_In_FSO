...
<script
	...
	crossorigin="anonymous"></script>
<title>Quản Lý Nhà Hàng | Đặt hàng</title>
...
<body>
	...
	<div class="container mt-2">
		...
		<form:form id="form" 
			...
			<div class="col-6">
			    <div class="form-group">
			        ...
			        <form:input type="text" 
			            ...
			            id="tenKH" 
			            path="tenKH" 
			            placeholder="Nhập tenKH..." 
			            value="${thongTinDatHang.tenKH}"/> 
			        <span class="form-message"></span>
			    </div>
			    <div class="form-group">
				    <label for="maLoaiKH">maLoaiKH</label> 
				    <form:select 
				        id="maLoaiKH" 
				        class="custom-select" 
				        path="maLoaiKH" 
				        value="${thongTinDatHang.maLoaiKH}">
				        <form:option value="">--maLoaiKH--</form:option>
				        <c:forEach items="${loaiKHs}" var="loaiKH" varStatus="var">
				        <form:option value="${loaiKH.maLoaiKH}">${loaiKH.maLoaiKH} - ${loaiKH.tenLoaiKH}</form:option>
				        </c:forEach>
				    </form:select> 
				    <span class=form-message-server> ${messageErrorMaLoaiKH}</span>
				    <span class="form-message"></span>
				</div>
			    <div class="form-group">
			...
			<div class="col-6">
			    <div class="form-group">
			        <label for="ngayOrder">ngayOrder</label> 
			        <form:input type="date" 
			            class="form-control" 
			            id="ngayOrder" 
			            path="ngayOrder" 
			            placeholder="Nhập ngayOrder..." 
			            value="${thongTinDatHang.ngayOrder}"/> 
			        <span class="form-message"></span>
			    </div>
			    <div class="form-group">
			...
			<div class="d-flex justify-content-end w-100">
				...
				<button type="submit" class="btn btn-primary mr-2">Đặt hàng</button>
