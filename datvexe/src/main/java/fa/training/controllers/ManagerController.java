...
public class ManagerController {
	...
	public String saveAdd(@ModelAttribute(name = "datVeXe") DatVeXe datVeXe, Model model) {
		KhachHang khachHang = new KhachHang(
				...
				datVeXe.getNgaySinh(),
				datVeXe.getGioiTinh(), 
				datVeXe.getSoDienThoai(), 
				datVeXe.getTrangThaiTiem(),
				datVeXe.getKetQuaSetNghiem(), 
				datVeXe.getNgaySetNghiem());
		...
		DatVe datVe = new DatVe("DV"+DateUtil.getTimeStamp(), datVeXe.getcCCD(), datVeXe.getNgayDatVe(), datVeXe.getBienSoXe(), datVeXe.getDiaDiemXuatPhat(), datVeXe.getDiaDiemDen(),
	...
	public String saveEdit(@ModelAttribute(name = "khachHang") KhachHang editKhachHang, RedirectAttributes attributes) {
		...
		if (khachHang.isPresent()) {
			...
			attributes.addFlashAttribute("messageSuccess", "Sửa khách hàng " + khachHang.get().getcCCD() + " thành công");
			List<DatVe> datVes = datVeService.findAll();
