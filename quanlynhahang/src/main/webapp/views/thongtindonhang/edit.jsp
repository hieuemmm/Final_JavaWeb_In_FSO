...
<body>
	...
	<div class="container mt-2">
		...
		<form:form id="form" 
			...
			method="POST"
			action="/quanlybanghang/saveEdit"
			...
			<div class="col-6">
			    <div class="form-group">
			        <label for="maDH">maDH: ${thongTinDonHang.maDH}</label> 
			        <form:hidden
			            path="maDH"
			            value="${thongTinDonHang.maDH}"/>
			    </div>
			    <div class="form-group">
			    ...
			    <div class="form-group">
			        <label for="ngayDatMay">ngayDatMay(*): ${thongTinDonHang.ngayDatMay}</label> 
			        <form:hidden
			            path="ngayDatMay"
			    ...
			    <div class="form-group">
			        <label for="ngayTra">ngayTra(*)</label> 
			        <form:input type="date" 
			            class="form-control" 
			            id="ngayTra" 
			            path="ngayTra" 
			            placeholder="Nhập ngayTra..." 
			            value="${thongTinDonHang.ngayTra}"/> 
			        <span class="form-message"></span>
			    </div>
			</div>
			<div class="col-6">
			    <div class="form-group">
			        <label for="maCTDH">maCTDH: ${thongTinDonHang.maCTDH}</label> 
			        <form:hidden 
			            path="maCTDH" 
			            value="${thongTinDonHang.maCTDH}"/>
			    </div>
			    <div class="form-group">
